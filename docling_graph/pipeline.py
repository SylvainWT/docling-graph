...
def _get_model_config(config_data: Dict, backend_type: str, inference: str, 
    ...
    if not model_config:
        raise ValueError(f"No configuration found for backend_type='{backend_type}' with inference='{inference}'")
...
def run_pipeline(config: Dict[str, Any]):
    ...
    try:
        ...
        converter = GraphConverter(add_reverse_edges=reverse_edges)
